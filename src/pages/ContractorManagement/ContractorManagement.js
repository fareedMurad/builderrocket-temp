...
const ContractorManagement = () => {
  ...
  const deleteContractorModal = () => {
    return (
      <Modal size="lg" centered show={showDeleteModal} onHide={cancelDeletion}>
        <Modal.Body>
            ...
            return (
              <>
                <tr className="contractor-type-row">
                  <td colSpan={7} className="contractor-type-name">
                    {type.Name}
                  </td>
                </tr>
                <tr>
                ...
                {handleContractors(type?.ID).map((contractor, index) => {
                  return (
                    <tr key={index}>
                      ...
                      <td
                        className={`${contractor?.Notes && "sticky-note-red"}`}
                      >
                        <OverlayTrigger
                          placement="top"
                          overlay={
                        ...
                        {isLoading && selectedContractorID === contractor.ID ? (
                          ...
                          <div className="d-flex justify-content-between">
                            ...
                            <i
                              ...
                              onClick={() =>
                                deleteContractorConfirmation(contractor.ID)
                              }
                            ></i>
                          </div>
                        )}
