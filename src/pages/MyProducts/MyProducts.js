...
import { deleteMyProduct, createMyProduct, setSelectedMyProduct, editMyProduct, getMyProducts } from '../../actions/myProductActions';
...
const MyProducts = () => {
    ...
    const myProducts = useSelector(state => state.myProduct.myProducts?.Products);
    const selectedMyProduct = useSelector(state => state.myProduct.selectedMyProduct);
