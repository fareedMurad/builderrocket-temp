...
const ColorProductModal = (props) => {
  ...
  const handleCheckBox = (roomID) => {
    ...
    if (roomList?.includes(roomID)) {
      ...
      if (index > -1) tempRoomList.splice(index, 1);
    ...
    >
      <div className="header-container">
        ...
        <div className="product-details inverse-form">
          <div className="product-details-header">Select Paint:</div>
          <div className="row">
            <div className="col-6">
              ...
              <div className="form-group row justify-content-end">
                <a
                  className="btn primary-gray-btn mr-5"
              ...
              {selectedPaint ? (
                <div className="row">
                  ...
                  <div className="col-sm-9">
                    <span>
                      {brands?.find((b) => b.ID === paintInfo?.Brand)?.Name}
                    </span>
                    <div className="mb-2">
                        ...
                        <Form.Check
                          ...
                          onChange={() =>
                            setPaintInfo({
                              ...
                              Location: {
                                ...paintInfo.Location,
                                Ceiling: !paintInfo?.Location.Ceiling,
                              },
                            })
                          }
                        />
      ...
      <div className="product-modal-body">
        <div className="body-header">
          Would you like to add to these rooms as well?
        </div>
        ...
        <div className="d-flex justify-content-center">
          <Button variant="link" className="cancel" onClick={handleCloseModal}>
            Cancel
          </Button>
          <Button
