                ...
                <div className='middle-section pt-1'>
                    ...
                    <div className='d-flex gap-2'>
                        <div>
                            ...
                            <div className=''>
                                {project?.Customers?.[0]?.Phone && <div className='pr-3 text phone'>
                                ...
                                {project?.Customers?.[0]?.Email && <div className='text email'>
                                    <i className='fas fa-envelope mr-2'></i>
                                    <a href={`mailto:${project?.Customers?.[0]?.Email}`}>
                                        {project?.Customers?.[0]?.Email}
                                    </a>
                                </div>}
                                {(project?.Customers?.[0]?.FirstName || project?.Customers?.[0]?.LastName) && <div className=''>
                                    <button
                        ...
                        <div className=''>
                            ...
                            {project?.Customers?.[1]?.Email && <div className='text email'>
                                <i className='fas fa-envelope mr-2'></i>
                                <a href={`mailto:${project?.Customers?.[1]?.Email}`}>
                                    {project?.Customers?.[1]?.Email}
                                </a>
                            </div>}
                            {(project?.Customers?.[1]?.FirstName || project?.Customers?.[1]?.LastName) && <div className=''>
                                <button
