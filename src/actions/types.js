...
// vendor
export const SET_VENDOR_SELECTED_PROJECT_TAB = 'SET_VENDOR_SELECTED_PROJECT_TAB';
...
export const SET_REPLACE_OLD_PRODUCT = 'SET_REPLACE_OLD_PRODUCT';
export const SET_REPLACE_OLD_PRODUCT_DETAILS = 'SET_REPLACE_OLD_PRODUCT_DETAILS';
...
export const SET_SELECTED_MY_PRODUCT = 'SET_SELECTED_MY_PRODUCT';
export const GET_MY_PRODUCTS_BY_PROJECT = 'GET_MY_PRODUCTS_BY_PROJECT';
...
// builder rooms
export const GET_BUILDER_ROOM_GROUPS = 'GET_BUILDER_ROOM_GROUPS';
export const GET_BUILDER_ROOM_TYPES = 'GET_BUILDER_ROOM_TYPES';
export const GET_BUILDER_SELECTED_ROOM_TYPE = 'GET_BUILDER_SELECTED_ROOM_TYPE';
export const GET_BUILDER_SELECTED_ROOM_GROUP = 'GET_BUILDER_SELECTED_ROOM_GROUP';
export const GET_BUILDER_SELECTED_ROOM_CATEGORY = 'GET_BUILDER_SELECTED_ROOM_CATEGORY';
export const GET_BUILDER_SELECTED_ROOM_CATEGORY_PRODUCTS = 'GET_BUILDER_SELECTED_ROOM_CATEGORY_PRODUCTS';

// product 
export const SET_PRODUCT_LOADING = 'SET_PRODUCT_LOADING';
export const SET_PRODUCT = 'SET_PRODUCT';
export const SET_REPLACE_PRODUCT = 'SET_REPLACE_PRODUCT';
export const SET_REPLACE_PRODUCT_ROOMS = 'SET_REPLACE_PRODUCT_ROOMS';
